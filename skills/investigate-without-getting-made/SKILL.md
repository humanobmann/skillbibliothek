...
description: >-
  Reporter and source-safety risk assessment for lawful, non-interactive public research.
  Use to prevent accidental account disclosure, protect legitimate sources and choose a
  low-exposure public-record or archive route. It does not authorise deceptive identities,
  evasion, access to closed systems, platform-control bypass, monitoring of people or covert
  due diligence. Reference at
...
## Local journalistic deployment guard

This locally governed version supports source and reporter safety, not covert
collection. Begin with `journalistic-osint-governance`. Choose a public,
non-interactive record, archive or official source instead of a target-facing
visit whenever possible. Do not create or age personas, use burner identities,
residential proxies, Tor, VPN rotation or similar measures to bypass a platform,
defeat attribution, obtain entry or observe a person without their knowledge.
Do not authenticate, join groups, initiate contact or interact under a false
pretext. If a source faces danger, route secure-communication and physical-safety
decisions to the responsible editor and qualified security/legal support rather
...
your organisation. See [../ETHICS.md](../../references/ETHICS.md). If you cannot justify
