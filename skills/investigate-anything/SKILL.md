...
For public-interest, political, human-rights, corporate-accountability or
cross-border reporting, load `journalistic-osint-governance` first. Its
documented scope, proportionality, source-protection, privacy and publication
gates override any broad downstream route. If the question targets a private
person, concerns sensitive data or could cause serious foreseeable harm, return
`HOLD FOR REVIEW` until the required editorial and jurisdiction-specific review
is recorded. Public availability is not permission to investigate or publish.
...
Read [../ETHICS.md](../../references/ETHICS.md), then write down five things:
